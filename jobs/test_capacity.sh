...
# Loop from 1- 9
for i in {1..9}
    sbatch --exclude=fang1,fang8,fang31,fang40,fang54,fang48,fang51,fang52,fang53,fang54 --job-name=cap$i --gres=gpu:4 --mem-per-gpu=11G --nodes=1 --output=./jobs/logs/capcaity_run_$SLURM_JOBID/$i.log --error=./jobs/logs/$SLURM_JOBID/$i.err --wrap="jobs/train_single.sh 94 test_94_$i"
done