...
python src/plot_hist.py -d -c aug_run -n hist_plots/aug_run.pdf
python src/plot_hist.py -d -c bs_test -n hist_plots/bs_run.pdf
python src/plot_hist.py -d -c lr_run -n hist_plots/lr_run.pdf
python src/plot_hist.py -d -c capacity -n hist_plots/capacity_run.pdf
python src/plot_hist.py -d -c loss_test -n hist_plots/loss_run.pdf
python src/plot_hist.py -d -c lr_run_0.00000 -n hist_plots/lr_run_small.pdf
python src/plot_hist.py -d -fs training_history_lr_run_0.000007_94.csv -n hist_plots/lr_run_best.pdf
