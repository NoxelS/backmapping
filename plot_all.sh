...
sbatch --wrap="python src/plot_hist.py -c prod -n hist_plots/all_prod.pdf"
sbatch --wrap="python src/plot_hist.py -c prod_angle -n hist_plots/prod_angles.pdf"
sbatch --wrap="python src/plot_hist.py -c prod_bond -n hist_plots/prod_bonds.pdf"