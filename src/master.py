...
def sendUpdateMail(finished_models: list, number_of_models: int):
    ...
    text_part.add_alternative(
        f"<h1>Training History Update ({len(finished_models)}/{number_of_models} models finished training)</h1><img src='cid:training_history.png'>", subtype="html"
    )
